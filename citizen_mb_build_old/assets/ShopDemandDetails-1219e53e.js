import{f as C,b as s,j as n}from"./index-dc2e80f3.js";import{a as j}from"./useCustomQuery-d19cb7d6.js";import{R as F}from"./RentalApiList-2e3f3ec6.js";import"./ApiHeader2-b363f7b8.js";function O(){var a,r,c,d,m,h,p,N,x,v,f,u,b,y,g,R,A,w,D,P,_;const T=C(),o=new URLSearchParams(T.search),i=o.get("shop_id"),l=o.get("month"),{api_shop_generate_demand:k}=F(),{data:e,isLoading:I,isError:M}=j({key:"api_shop_generate_demand",api:k,config:{shopId:i,month:l},options:{enabled:!!i&&!!l}}),S="  "+((a=e==null?void 0:e.data)==null?void 0:a.ulbName)+`
