import{i as C,b as s,j as n}from"./index-edad28b0.js";import{a as j}from"./useCustomQuery-f6799d9f.js";import{R as F}from"./RentalApiList-82cf3775.js";import"./ApiHeader2-b363f7b8.js";function O(){var a,r,c,d,m,p,h,N,x,v,f,u,b,y,g,R,A,w,D,P,T;const _=C(),i=new URLSearchParams(_.search),o=i.get("shop_id"),l=i.get("month"),{api_shop_generate_demand:k}=F(),{data:e,isLoading:M,isError:I}=j({key:"api_shop_generate_demand",api:k,config:{shopId:o,month:l},options:{enabled:!!o&&!!l}}),L="  "+((a=e==null?void 0:e.data)==null?void 0:a.ulbName)+`
[C]Municipal Rental Demand Receipt
...
Amount: `+((p=e==null?void 0:e.data)==null?void 0:p.totalAmount)+`
